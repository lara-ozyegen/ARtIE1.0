PROJECT GROUP: G3F
PROJECT NAME: ARtIE
PROJECT DESCRIPTION: Our project, ARtIE, is based on displaying 3D models in real life to improve education and provide information using visualization. Our project is an android app so we are using AndroidStudio.
